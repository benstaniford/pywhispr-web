...
pywhispr-web is a Flask application designed for containerized deployment. It currently provides a simple hello world application with authentication, Docker support, and production-ready infrastructure. It includes session-based authentication, health checks, and is designed for production deployment using Gunicorn.
