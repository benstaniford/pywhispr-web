...
A production-ready Flask web application with authentication, Docker support, and CI/CD infrastructure.
...
- `GET /api/data` - Data API endpoint (requires authentication)
...
Development notes for extending PyWhispr Web:

1. Add application logic to `app.py`
...
PyWhispr Web is provided as-is. See [LICENSE](LICENSE) for details.